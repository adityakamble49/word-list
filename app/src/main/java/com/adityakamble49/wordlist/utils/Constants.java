...
public class Constants {
    ...
    public static class ReferenceUrls {
        ...
        public static final String CREDIT_WORD_LIST = "https://github.com/maykulkarni/Manhattan-GRE-Words-Shuffled";
        public static final String CREDIT_APP_ICON = "https://www.flaticon.com/free-icon/checklist_273504#term=list&page=1&position=96";
    }
}
